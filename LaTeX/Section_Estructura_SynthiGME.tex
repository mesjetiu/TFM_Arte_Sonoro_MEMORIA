 \section[Estructura del \textit{quark} \appName]{Estructura del \textit{quark} \appName}
\sectionmark{Estructura del \textit{quark}}

A continuación se muestra el árbol de directorios en los que se organiza el \textit{Quark} de \appName. En él no se muestran los archivos concretos que albergan las definiciones de las clases, a excepción del de la clase principal \texttt{SynthiGME} y los que están alojados en el directorio raíz. 
