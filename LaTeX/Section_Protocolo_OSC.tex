...
\begin{table}
	\begin{center}
		\begin{tabular}{ lcllr }
			...
			\multirow{4}{*}{\texttt{/out}}	& \multirow{4}{*}{\texttt{/[1-8]}}	& \texttt{/filter}	&\texttt{[-5-5]} & \multirow{4}{*}{\textit{Output Channels}}\\
